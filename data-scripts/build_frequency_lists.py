...
DICTIONARIES = dict(
    ...
    dutch_wikipedia=30000,
    passwords=30000,
    surnames=10000,
    dutch_surnames=10000,
    male_names=None,
    dutch_male_names=None,
    female_names=None,
    dutch_female_names=None,
)
...
def main():
    ...
    with codecs.open(output_file, 'w', 'utf8') as f:
        ...
        f.write('package zxcvbn_go_nl_frequency // generated by %s\n\n' % script_name)
